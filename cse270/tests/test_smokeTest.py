...
class TestSmokeTest():
  ...
  def test_adminpage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("Samplery")
    ...
    self.driver.find_element(By.ID, "password").send_keys("Mismatch")
  ...
  def test_joinpage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Solomon")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Aliche")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Sodium Alliance Pty")
